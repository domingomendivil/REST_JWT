...
public class RestTest extends JerseyTest {
	...
	protected Application configure() {
		...
		RestAPI restExample = new RestAPI();
		...
		res.packages(true, "uy.gub.dgi.rest").register(RolesAllowedDynamicFeature.class);
	...
	// Si el usuario no es válido que retorne un 401 - Unauthorized
	@Test
	...
	public void testProfile1() {
		when(authenticator.validUser("","")).thenReturn(false);
		Response res = target("rest/profile").request().get();
		Assert.assertEquals(401,res.getStatus());
	}
